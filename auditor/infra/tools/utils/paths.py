"""Path utility functions for tool implementations.

This module provides path manipulation utilities used by tool wrappers
including path normalization and resolution.
...
Examples
--------
>>> from auditor.infra.tools.utils.paths import normalize_path
>>> path = normalize_path("./src/../lib/file.py")
